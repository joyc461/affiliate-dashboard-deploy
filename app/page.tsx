 ...
 * Generates the deterministic 10,000 row dataset on the server and passes it down
 * to the client dashboard container, avoiding client-side data fetching waterfalls.
 */
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 py-8 px-4 sm:px-6 lg:px-8 transition-colors">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Interactive Client Dashboard Container */}
